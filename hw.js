...
// Ваше завдання — виконати всі проміси одночасно за допомогою Promise.all 
// і обробити результати.
...
// Створіть масив з 5 промісів, використовуючи функцію delayedPromise, 
...
const promises = [
    delayedPromise(1, 900),
    delayedPromise(2, 1000),
    delayedPromise(3, 1200),
...
// Створіть масив з 5 промісів, використовуючи функцію randomDelay, 
// із різними значеннями.
...
Promise.race((promises2)).then((res) => {
  console.log(res)
})